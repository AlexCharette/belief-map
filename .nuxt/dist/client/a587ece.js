(window["webpackJsonp"] = window["webpackJsonp"] || []).push([[6,2,5],{
...
var update = add("832c434a", content, false, {"sourceMap":false});
...
/* harmony default export */ var BaseWidgetvue_type_script_lang_ts_ = (vue_runtime_esm["default"].extend({
  name: 'BaseWidget',
...
// EXTERNAL MODULE: ./components/BaseWidget.vue?vue&type=style&index=0&lang=scss&
var BaseWidgetvue_type_style_index_0_lang_scss_ = __webpack_require__(178);
...
// add the styles to the DOM
var add = __webpack_require__(83).default
var update = add("b7ac8fde", content, false, {"sourceMap":false});
// Hot Module Replacement
if(false) {}
...
var BaseWidget = __webpack_require__(175);
...
/* harmony default export */ var AddBeliefvue_type_script_lang_ts_ = (vue_runtime_esm["default"].extend({
  name: 'AddBelief',
  components: {
  ...
  data: function data() {
    return {
      ...
      nameRules: [function (v) {
        return !!v || 'You must enter a name';
      }],
      typeRules: [function (v) {
        return !!v || 'You must choose a type';
      }],
      valid: true
    };
  },
  computed: {
    beliefTypes: function beliefTypes() {
      return Object.keys(BeliefType);
    },
    hasCopyData: function hasCopyData() {
      var copiedNode = this.$store.state.nodes.copiedNode;
      return Object.keys(copiedNode).length > 0;
    },
    node: function node() {
      var value = this.formData.type[0].toLowerCase() + this.formData.type.slice(1);
      return {
        id: v4["a" /* default */](),
  ...
  methods: {
    addReferenceSlot: function addReferenceSlot() {
      this.formData.references.push({
        text: '',
        link: ''
      });
    },
    subtractReferenceSlot: function subtractReferenceSlot() {
      this.formData.references.pop();
    },
    close: function close() {
      this.$nuxt.$emit('add-belief-closed');
    },
    pasteDetails: function pasteDetails() {
      var details = this.$store.state.nodes.copiedNode;
      this.formData = {
        name: details.name,
        notes: details.notes,
    ...
    submit: function submit() {
      var selectedNode = this.$store.state.nodes.selectedNode;
...
// EXTERNAL MODULE: ./components/AddBelief.vue?vue&type=style&index=0&lang=scss&
var AddBeliefvue_type_style_index_0_lang_scss_ = __webpack_require__(196);
...
installComponents(component, {BaseWidget: __webpack_require__(175).default})
...
// add the styles to the DOM
var add = __webpack_require__(83).default
var update = add("b98ca11e", content, false, {"sourceMap":false});
// Hot Module Replacement
if(false) {}
...
var AddBelief = __webpack_require__(200);
...
/* harmony default export */ var BeliefDetailsvue_type_script_lang_ts_ = (vue_runtime_esm["default"].extend({
  name: 'BeliefDetails',
  components: {
  ...
  methods: {
    getFormattedTypeAndIcon: function getFormattedTypeAndIcon(type) {
      return iconDataMap[type];
    },
    copyDetails: function copyDetails() {
    ...
    deleteBelief: function deleteBelief() {
  ...
  created: function created() {
    var self = this;
    this.$nuxt.$on('add-belief-closed', function () {
...
// EXTERNAL MODULE: ./components/BeliefDetails.vue?vue&type=style&index=0&lang=scss&
var BeliefDetailsvue_type_style_index_0_lang_scss_ = __webpack_require__(286);
...
/* nuxt-component-imports */
installComponents(component, {AddBelief: __webpack_require__(200).default,BaseWidget: __webpack_require__(175).default})
